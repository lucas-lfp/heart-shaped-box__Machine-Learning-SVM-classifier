...
nav = st.sidebar.radio("NAVIGATION", ["Home", "Preliminary Work", "Age", "Sex", "BMI, Height & Weight", "Blood Pressure", "Glucose & Cholesterol", "Lifestyle", "Target Feature", "Conclusion"])
...
if nav == "Home":
    ...
    st.write(
        ...
        <div class = 'all'>
            <p class = 'titlep_2'>
                Data Science with Real-Life Clinical Data
            </p>
            <p class = 'title_sp'>
                <i>Part I: Dataset Analysis & Data Viz</i>
            </p>
        </div>
        """, unsafe_allow_html=True
...
if nav == "Preliminary Work":
    ...
    st.write(df_raw.describe().round(1))
